...
public class ModifiedJigsawPlacement {
    ...
    public static Optional<Structure.GenerationStub> addPieces(Structure.GenerationContext p_227239_, Holder<StructureTemplatePool> p_227240_, Optional<ResourceLocation> p_227241_, int p_227242_, BlockPos p_227243_, boolean p_227244_, Optional<Heightmap.Types> p_227245_, int p_227246_) {
        ...
        if (structurepoolelement == EmptyPoolElement.INSTANCE) {
            ...
            int bX = Math.abs(boundingbox.getXSpan() / 2);

            int bZ = Math.abs(boundingbox.getZSpan() / 2);

            int l = boundingbox.minY() + poolelementstructurepiece.getGroundLevelDelta();
            poolelementstructurepiece.move(-bX, k - l, -bZ);
    ...
    private static void addPieces(RandomState p_227211_, int p_227212_, boolean p_227213_, ChunkGenerator p_227214_, StructureTemplateManager p_227215_, LevelHeightAccessor p_227216_, RandomSource p_227217_, Registry<StructureTemplatePool> p_227218_, PoolElementStructurePiece p_227219_, List<PoolElementStructurePiece> p_227220_, VoxelShape p_227221_) {
        net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.Placer jigsawplacement$placer = new net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.Placer(p_227218_, p_227212_, p_227214_, p_227215_, p_227220_, p_227217_);
        jigsawplacement$placer.placing.addLast(new net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.PieceState(p_227219_, new MutableObject<>(p_227221_), 0));

        while (!jigsawplacement$placer.placing.isEmpty()) {
            net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.PieceState jigsawplacement$piecestate = jigsawplacement$placer.placing.removeFirst();
    ...
    static final class Placer {
        ...
        final Deque<net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.PieceState> placing = Queues.newArrayDeque();
            ...
            for (StructureTemplate.StructureBlockInfo structuretemplate$structureblockinfo : structurepoolelement.getShuffledJigsawBlocks(this.structureTemplateManager, blockpos, rotation, this.random)) {
                ...
                if (optional.isPresent() && (optional.get().size() != 0 || Objects.equals(resourcelocation, Pools.EMPTY.location()))) {
                    ...
                    if (optional1.isPresent() && (optional1.get().size() != 0 || Objects.equals(resourcelocation1, Pools.EMPTY.location()))) {
                                    ...
                                    if (JigsawBlock.canAttach(structuretemplate$structureblockinfo, structuretemplate$structureblockinfo1)) {
                                        ...
                                        if (!Shapes.joinIsNotEmpty(mutableobject1.getValue(), Shapes.create(AABB.of(boundingbox3).deflate(0.25D)), BooleanOp.ONLY_SECOND)) {
                                            ...
                                            if (p_227267_ + 1 <= this.maxDepth) {
                                                this.placing.addLast(new net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.PieceState(poolelementstructurepiece, mutableobject1, p_227267_ + 1));
                                            }
                                            continue label139;
                                        }
                                    }
                        ...
                        net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.LOGGER.warn("Empty or non-existent fallback pool: {}", (Object) resourcelocation1);
                    }
                } else {
                    net.aurelj.dungeons_arise.structures.ModifiedJigsawPlacement.LOGGER.warn("Empty or non-existent pool: {}", (Object) resourcelocation);
                }
            }
